...
export const Route = createFileRoute("/breathe/")({ 
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://app.peacecode.in/api/og/breathe.svg?title=Breathe+%E2%80%94+techniques+that+regulate+you+%E2%80%94+PeaceCode" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:image", content: "https://app.peacecode.in/api/og/breathe.svg?title=Breathe+%E2%80%94+techniques+that+regulate+you+%E2%80%94+PeaceCode" },
    ],
