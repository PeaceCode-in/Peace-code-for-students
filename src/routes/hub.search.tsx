...
export const Route = createFileRoute("/hub/search")({ 
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://app.peacecode.in/api/og/hub/search.svg?title=v%24%7Bx.version%7D+%C2%B7+%24%7Bx.codename%7D" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:image", content: "https://app.peacecode.in/api/og/hub/search.svg?title=v%24%7Bx.version%7D+%C2%B7+%24%7Bx.codename%7D" },
    ],
