...
export const Route = createFileRoute("/counselling/upcoming")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://app.peacecode.in/api/og/counselling/upcoming.svg?title=Upcoming+sessions+%E2%80%94+PeaceCode" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:image", content: "https://app.peacecode.in/api/og/counselling/upcoming.svg?title=Upcoming+sessions+%E2%80%94+PeaceCode" },
    ],
