...
export const Route = createFileRoute("/mindgym/paths")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://app.peacecode.in/api/og/mindgym/paths.svg?title=Guided+paths+%E2%80%94+PeaceCode" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:image", content: "https://app.peacecode.in/api/og/mindgym/paths.svg?title=Guided+paths+%E2%80%94+PeaceCode" },
    ],
