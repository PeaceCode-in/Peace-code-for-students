...
export const Route = createFileRoute("/hub/whats-new")({ 
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://app.peacecode.in/api/og/hub/whats-new.svg?title=PeaceCode" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:image", content: "https://app.peacecode.in/api/og/hub/whats-new.svg?title=PeaceCode" },
    ],
