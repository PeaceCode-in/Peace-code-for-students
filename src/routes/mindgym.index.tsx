...
export const Route = createFileRoute("/mindgym/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://app.peacecode.in/api/og/mindgym.svg?title=Mind+Gym+%E2%80%94+train+your+inner+skills+%E2%80%94+PeaceCode" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:image", content: "https://app.peacecode.in/api/og/mindgym.svg?title=Mind+Gym+%E2%80%94+train+your+inner+skills+%E2%80%94+PeaceCode" },
    ],
